...
public class IntListTest {
    ...
    public void testReverse() {
        IntList t1 = IntList.list(3,2,1,4);
        IntList t4 = IntList.list(3,2,1,4);
        IntList t3 = IntList.list(4,1,2,3);
        IntList t2 = IntList.reverse(t1);
        IntList t5 = null;

        assertEquals(t2, t3);
        assertNotEquals(t1,t4);
        assertEquals(IntList.reverse(t5), null);
    }
